<template>
    <div>
        ...
        <br/>
        <div class="alert alert-warning" v-if="!isFetching && pictureOfEvents && pictureOfEvents.length === 0">
            <span>No pictureOfEvents found</span>
        </div>
        <div class="table-responsive" v-if="pictureOfEvents && pictureOfEvents.length > 0">
            <table class="table table-striped">
                <thead>
                <tr>
                    <th><span>ID</span></th>
                    <th><span>Pic Date</span></th>
                    <th><span>Img Type</span></th>
                    <th><span>Img File</span></th>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="pmillApp.pictureOfEvent.delete.question">Confirm delete operation</span></span>
