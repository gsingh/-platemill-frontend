    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="pmillApp.videoOfEvent.home.createOrEditLabel">Create or edit a VideoOfEvent</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="video-of-event-videoType">Video Type</label>
                        <input type="text" class="form-control" name="videoType" id="video-of-event-videoType"
                            :class="{'valid': !$v.videoOfEvent.videoType.$invalid, 'invalid': $v.videoOfEvent.videoType.$invalid }" v-model="$v.videoOfEvent.videoType.$model" />
                    </div>
                    <div class="form-group">
