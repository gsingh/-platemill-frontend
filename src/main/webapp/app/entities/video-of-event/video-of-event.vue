<template>
    <div>
        ...
        <br/>
        <div class="alert alert-warning" v-if="!isFetching && videoOfEvents && videoOfEvents.length === 0">
            <span>No videoOfEvents found</span>
        </div>
        <div class="table-responsive" v-if="videoOfEvents && videoOfEvents.length > 0">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="pmillApp.videoOfEvent.delete.question">Confirm delete operation</span></span>
