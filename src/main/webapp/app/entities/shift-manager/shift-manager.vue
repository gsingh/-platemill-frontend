<template>
    <div>
        ...
        <br/>
        <div class="alert alert-warning" v-if="!isFetching && shiftManagers && shiftManagers.length === 0">
            <span>No shiftManagers found</span>
        </div>
        <div class="table-responsive" v-if="shiftManagers && shiftManagers.length > 0">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="pmillApp.shiftManager.delete.question">Confirm delete operation</span></span>
