...
To optimize the pmill application for production, run:
...
For example, to start a h2disk database in a docker container, run:

    docker-compose -f src/main/docker/h2disk.yml up -d

To stop it and remove the container, run:

    docker-compose -f src/main/docker/h2disk.yml down
